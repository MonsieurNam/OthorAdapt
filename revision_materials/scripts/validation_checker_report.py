...
COMMANDS=Path(os.environ.get('VALIDATION_COMMANDS',ROOT/'revision_materials/scripts/validation_sweep_commands.sh'))
MANIFEST=Path(os.environ.get('VALIDATION_MANIFEST',ROOT/'revision_materials/results/validation_sweep_ramp100_results.jsonl'))
LOGDIR=Path(os.environ.get('VALIDATION_LOGDIR',ROOT/'revision_materials/logs/validation_sweep_ramp100'))
