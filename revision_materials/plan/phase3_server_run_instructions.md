...
Phase 3 row exists, it falls back to `validation_sweep_ramp100_results.jsonl`
...
- `--report_test`
- `--run_manifest revision_materials/results/phase3_main_ramp100_results.jsonl`
- `$PYTHON` as the interpreter, defaulting to `python3`
- `2>&1 | tee revision_materials/logs/phase3_main_ramp100/<run>_${RUN_STAMP}.log`
...
python aggregate_results.py \
  --manifest revision_materials/results/phase3_main_ramp100_results.jsonl \
  --out_csv revision_materials/results/phase3_main_ramp100_summary.csv \
